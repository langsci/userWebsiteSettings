{**
 * public/generic/userWebsiteSettings/templates/profileModified.tpl
 *
...
<p><a href="{$linkToWebsiteSettings}">My Website Settings</a></p>
<p><a href="{$linkToCommunitySettings}">My Community Settings</a></p>
